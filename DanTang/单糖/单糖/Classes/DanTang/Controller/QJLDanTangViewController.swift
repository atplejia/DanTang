//
//  QJLDanTangViewController.swift
//  单糖
//
...
class QJLDanTangViewController: QJLBaseViewController {
    
    var channels = [QJLChannel]()
    // 标签
...
extension QJLDanTangViewController: UIScrollViewDelegate {
