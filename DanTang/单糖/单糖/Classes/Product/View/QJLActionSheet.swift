...
class QJLActionSheet: UIView {

    class func show() {
        let actionSheet = QJLActionSheet()
        actionSheet.frame = UIScreen.mainScreen().bounds
        actionSheet.backgroundColor = QJLColor(0, g: 0, b: 0, a: 0.6)
    ...
    private lazy var shareLabel: UILabel = {
        ...
        shareLabel.text = "分享到"
        shareLabel.textColor = QJLColor(0, g: 0, b: 0, a: 0.7)
        shareLabel.textAlignment = .Center
        return shareLabel
    }()
    // 6个按钮
    private lazy var shareButtonView: QJLShareButtonView = {
        let shareButtonView = QJLShareButtonView()
    ...
    private lazy var cancelButton: UIButton = {
        ...
        cancelButton.setTitleColor(QJLColor(37, g: 142, b: 240, a: 1.0), forState: .Normal)
