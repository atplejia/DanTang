...
class ShopCartViewController: QJLBaseViewController {
    ...
    private let supermarketTableView  = LFBTableView(frame: CGRectMake(0, 66, ScreenWidth, ScreenHeight - 64 - 50), style: .Plain)
    ...
    private func buildEmptyUI() {
        ...
        emptyLabel.textColor = QJLColor(100, g: 100, b: 100,a: 1)
        ...
        emptyButton.setTitleColor(QJLColor(100, g: 100, b: 100,a: 1), forState: UIControlState.Normal)
    ...
    private func buildSupermarketTableView() {
        ...
        tableFooterView.frame = CGRectMake(0, ScreenHeight - 50, ScreenWidth, 50)
        ...
        supermarketTableView.rowHeight = 50
    ...
    private func buildSignTimeView() {
        let signTimeView = UIView(frame: CGRectMake(0, 150, view.width, 50))
        ...
        signTimeTitleLabel.frame = CGRectMake(15, 0, signTimeTitleLabel.width, 50)
        signTimeView.addSubview(signTimeTitleLabel)
        
        signTimeLabel.frame = CGRectMake(CGRectGetMaxX(signTimeTitleLabel.frame) + 10, 0, view.width * 0.5, 50)
        ...
        reserveLabel.frame = CGRectMake(view.width - 72, 0, 60, 50)
        signTimeView.addSubview(reserveLabel)
        
        let arrowImageView = UIImageView(image: UIImage(named: "icon_go"))
        arrowImageView.frame = CGRectMake(view.width - 15, (50 - arrowImageView.height) * 0.5, arrowImageView.width, arrowImageView.height)
        signTimeView.addSubview(arrowImageView)
        
    }
    
    private func buildSignComments() {
        commentsView.frame = CGRectMake(0, 200, view.width, 50)
