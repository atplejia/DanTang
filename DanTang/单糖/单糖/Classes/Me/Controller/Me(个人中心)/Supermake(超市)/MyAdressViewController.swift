...
class MyAdressViewController: QJLBaseViewController {
    ...
    private func buildBottomAddAdressButtom() {
        let bottomView = UIView(frame: CGRectMake(0, ScreenHeight - 60, ScreenWidth, 60))
        bottomView.backgroundColor = UIColor.whiteColor()
        view.addSubview(bottomView)
        
        addAdressButton = UIButton(frame: CGRectMake(ScreenWidth * 0.15, 12, ScreenWidth * 0.7, 60 - 12 * 2))
        addAdressButton?.backgroundColor = QJLlobalRedColor()
