...
class ProductCell: UITableViewCell {
    ...
    private lazy var specificsLabel: UILabel = {
        ...
        specificsLabel.textColor = QJLColor(100, g: 100, b: 100,a: 1)
    ...
    private lazy var lineView: UIView = {
        let lineView = UIView()
        lineView.backgroundColor = QJLColor(100, g: 100, b: 100,a: 1)
        lineView.alpha = 0.05
        return lineView
    }()
    ...
    override func layoutSubviews() {
        ...
        fineImageView.frame = CGRectMake(CGRectGetMaxX(goodsImageView.frame), 10, 30, 16)
        
        if fineImageView.hidden {
            nameLabel.frame = CGRectMake(CGRectGetMaxX(goodsImageView.frame) + 3, 10 - 2, width - CGRectGetMaxX(goodsImageView.frame), 20)
        } else {
            nameLabel.frame = CGRectMake(CGRectGetMaxX(fineImageView.frame) + 3, 10 - 2, width - CGRectGetMaxX(fineImageView.frame), 20)
        }
        ...
        lineView.frame = CGRectMake(10, height - 1, width - 10, 1)
