...
class ProductsViewController: AnimationViewController {
    ...
    override func viewDidLoad() {
        ...
        view = UIView(frame: CGRectMake(ScreenWidth * 0.25, 0, ScreenWidth * 0.75, ScreenHeight))
    ...
    private func buildProductsTableView() {
        productsTableView = LFBTableView(frame: CGRectMake(0, 66, ScreenWidth * 0.75, ScreenHeight), style: .Plain)
        productsTableView?.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: 49, right: 0)
        productsTableView?.backgroundColor = QJLColor(239, g: 239, b: 239,a: 1)
