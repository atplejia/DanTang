...
class ProductDetailViewController: QJLBaseViewController {
    
    private let grayBackgroundColor = QJLColor(248, g: 248, b: 248,a: 1)
    ...
    init () {
        ...
        presentButton.backgroundColor = QJLColor(252, g: 85, b: 88,a: 1)
        ...
        brandLabel.textColor = QJLColor(150, g: 150, b: 150,a: 1)
        brandLabel.text = "品       牌"
        ...
        buildLineView(CGRectMake(0, ScreenHeight - 50, ScreenWidth, 1), addView: view)
        
        bottomView = UIView(frame: CGRectMake(0, ScreenHeight - 50, ScreenWidth, 60))
    ...
    convenience init(goods: Goods) {
        ...
        scrollView?.contentSize = CGSizeMake(ScreenWidth, CGRectGetMaxY(detailImageView!.frame) + 50 + 64)
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        navigationController?.navigationBar.barTintColor = QJLColor(245, g: 80, b: 83, a: 1.0)
