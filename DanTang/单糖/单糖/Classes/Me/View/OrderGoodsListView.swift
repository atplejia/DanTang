...
class OrderGoodsListView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        payLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
...
class GoodsView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        titleLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
        addSubview(titleLabel)
        
        numberLabel.font = UIFont.systemFontOfSize(14)
        numberLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
        addSubview(numberLabel)
        
        priceLabel.font = UIFont.systemFontOfSize(14)
        priceLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
...
class FeeView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        prictLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
