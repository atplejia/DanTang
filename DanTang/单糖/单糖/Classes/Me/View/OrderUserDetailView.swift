...
class OrderUserDetailView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        consigneeLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
        consigneeLabel.font = UIFont.systemFontOfSize(14)
        addSubview(consigneeLabel)
        
        consigneeAdressLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
        consigneeAdressLabel.font = UIFont.systemFontOfSize(12)
        addSubview(consigneeAdressLabel)
        
        phoneNumberLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
        ...
        shopLabel.textColor = QJLColor(50, g: 50, b: 50,a: 1)
        shopLabel.font = UIFont.systemFontOfSize(12)
        addSubview(shopLabel)
        
        collectionButton.setTitle("+ 收藏", forState: .Normal)
        collectionButton.setTitleColor(QJLColor(50, g: 50, b: 50,a: 1), forState: .Normal)
        collectionButton.setTitle("取消收藏", forState: .Selected)
        collectionButton.setTitleColor(UIColor.whiteColor(), forState: .Selected)
        collectionButton.setBackgroundImage(UIImage.imageWithColor(QJLlobalRedColor(), size: CGSizeMake(60, 25), alpha: 1), forState: UIControlState.Normal)
        collectionButton.setBackgroundImage(UIImage.imageWithColor(QJLlobalRedColor(), size: CGSizeMake(60, 25), alpha: 1), forState: .Selected)
