...
class QJLMeChoiceView: UIView {
    ...
    override func layoutSubviews() {
        ...
        orderView.frame = CGRectMake(0, 0, subViewW, height+15)
        couponView.frame = CGRectMake(subViewW, 0, subViewW, height+15)
        messageView.frame = CGRectMake(subViewW * 2, 0, subViewW, height+15)
        couponNumber?.frame = CGRectMake(subViewW * 1.56, 12, 15, 15)
        line1.frame = CGRectMake(subViewW - 0.5, height * 0.2, 1, height+5)
        line2.frame = CGRectMake(subViewW * 2 - 0.5, height * 0.2, 1, height+5)
    }
